    ...
    <div class="wrap">
      ...
      <div class="sec">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px">
          ...
          <div style="background:var(--s1);border:1px dashed rgba(255,255,255,.1);border-radius:14px;padding:20px;opacity:.55;cursor:not-allowed">
            <div style="font-size:1.6rem;margin-bottom:10px">&#128101;</div>
            <div style="font-weight:700;font-size:.9rem;margin-bottom:5px">Microsoft Teams</div>
            <div style="font-size:.78rem;color:var(--dim);line-height:1.5">Connector webhook URL. Teams messages route bidirectionally through the mesh.</div>
          </div>
          <div style="background:var(--s1);border:1px dashed rgba(255,255,255,.1);border-radius:14px;padding:20px;opacity:.55;cursor:not-allowed">
            <div style="font-size:1.6rem;margin-bottom:10px">&#128276;</div>
